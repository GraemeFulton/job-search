...
<div class="row">
  <?php                
        $content='[ajaxy-live-search post_types="work-experience-job" label="Search for Work Experience" width="500" delay="300" width="500" url="http://localhost/LGWP/?s=%s" border="1px solid #eee"]';
...
<?php
 echo '<hr><h3 style="margin-bottom:-20px;">Similar Jobs</h3>'.do_shortcode('[widgets_on_pages id="Related Experience"]');
	...
	<div id="secondary" class="widget-area col-md-4 col-sm-4" role="complementary">
		<?php 
 echo do_shortcode('[widgets_on_pages id="Related Experience Sidebar"]');
                get_sidebar(); ?>
	</div>
</div>
