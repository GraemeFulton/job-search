...
if(!class_exists('SP_BPCPM_InstallIndicator'))
{

if(SP_BPCPM_PRO)
{
    include_once('pro/SP_BPCPM_OptionsManager_Pro.php');
    class_alias('SP_BPCPM_OptionsManager_Pro', 'SP_BPCPM_OptionsManager_alias');
}
else
{
    include_once('SP_BPCPM_OptionsManager.php');
    class_alias('SP_BPCPM_OptionsManager', 'SP_BPCPM_OptionsManager_alias');
}


class SP_BPCPM_InstallIndicator extends SP_BPCPM_OptionsManager_alias {
