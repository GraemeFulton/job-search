<div class="item-list-tabs no-ajax clearfix break-row" id="admin-subnav" role="navigation">
	<ul>
...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<textarea clearfixs="10" cols="100" name="group-desc" id="group-desc" class="full" aria-required="true"><?php bp_group_description_editable(); ?></textarea>
...
<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
	...
	<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p>
				<input class="break-row-top" type="file" name="file" id="file" />
				<input class="break-row-top" type="submit" name="upload" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" />
				<input class="break-row-top" type="hidden" name="action" id="action" value="bp_avatar_upload" />
			</p>
...
<?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
	...
	<div class="bp-widget">
		...
		<ul id="admins-list" class="row item-list single-line">

			<?php while ( bp_members() ) : bp_the_member(); ?>
			<li class="col-md-6">
				<div class="row">
					<div class="col-md-4">
						<?php echo bp_core_fetch_avatar( array( 'item_id' => bp_get_member_user_id(), 'type' => 'full', 'alt' => sprintf( __( 'Profile picture of %s', 'buddypress' ), bp_get_member_name() ) ) ); ?>
					</div>
					<div class="col-md-8">
						<h6><a href="<?php bp_member_permalink(); ?>"> <?php bp_member_name(); ?></a></h6>
							<?php if ( count( bp_group_admin_ids( false, 'array' ) ) > 1 ) : ?>
							<span class="small">
								<a class="button confirm admin-demote-to-member" href="<?php bp_group_member_demote_link( bp_get_member_user_id() ); ?>">
									<?php _e( 'Demote to Member', 'buddypress' ); ?>
								</a>
							</span>
						<?php endif; ?>
					</div>
	...
	<?php if ( bp_group_has_moderators() ) : ?>
		<div class="bp-widget">
			...
			<?php if ( bp_has_members( '&include=' . bp_group_mod_ids() ) ) : ?>
				<ul id="mods-list" class="clearfix item-list bp-klein-fix-list single-line">
	...
	<div class="bp-widget">
		...
		<?php if ( bp_group_has_members( 'per_page=15&exclude_banned=false' ) ) : ?>
			...
			<?php if ( bp_group_member_needs_pagination() ) : ?>
				...
				<div class="clearfix pagination no-ajax">
			...
			<ul id="members-list" class="row clearfix item-list single-line">
				<?php while ( bp_group_members() ) : bp_group_the_member(); ?>

					<li class="col-md-12 row break-row-bottom <?php bp_group_member_css_class(); ?>">
						<div class="row">
							<div class="col-md-2">
								<?php bp_group_member_avatar(); ?>
							</div>	
							<div class="col-md-10">
								<h6><?php bp_group_member_link(); ?></h6>
...
<?php if ( bp_is_group_admin_screen( 'membership-requests' ) ) : ?>
	...
	<?php if ( bp_group_has_membership_requests() ) : ?>
		...
		<ul id="request-list" class="item-list bp-klein-fix-list">
			<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>
				...
				<li class="clearfix">
					...
					<div class="four columns omega">
						<h6 class="remove-bottom"><?php bp_group_request_user_link(); ?></h6>
						<blockquote>
							<p>
								<small>
						...
						<span class="small activity"><?php bp_group_request_time_since_requested(); ?></span>
