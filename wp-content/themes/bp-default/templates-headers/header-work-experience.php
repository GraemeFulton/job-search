            ...
            <div id="sidebar-toggle">
                    <div id="toggle-icon">
                        <button type="button" class="btn navbar-inverse ">
                            <span class="glyphicon fa fa-cogs fa-2x" style="color:rgb(228, 104, 228)"></span>
                        </button>
                    </div>
                </div>
...
?>
		...
		<div id="header" class="header-workexperience mobile-menu">                  
		...
		<div id="container">
                    ...
                    <div id="search-bar"  class="mobile-search mobile-menu" role="search">
                            <div id="main_search">
                                <form class="navbar-form" role="search">
                                    <div class="input-group">
                                     <input type="text" class="form-control Search_Term" id='Search_Term_Mobile' placeholder="Search for Work Experience Jobs" name="srch-term">
                                        <div class="input-group-btn">
