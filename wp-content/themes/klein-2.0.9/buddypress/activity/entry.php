		...
		<div class="activity-meta">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_comment() ) : ?>
					...
					<a href="<?php bp_activity_comment_link(); ?>" class="acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php printf( __( 'Comment <span class="count">%s</span>', 'buddypress' ), bp_activity_get_comment_count() ); ?></a>
