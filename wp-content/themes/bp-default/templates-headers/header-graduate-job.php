                            ...
                            <div id="main_search">
                                <form class="navbar-form" role="search">
                                    <div class="input-group">
                                     <input type="text" class="form-control Search_Term" id='Search_Term' placeholder="Search for Work" name="srch-term">
		...
		<div id="container">
                       ...
                       <div id="search-bar" class="mobile-search mobile-menu" role="search">
                            <div id="main_search">
                                <form class="navbar-form" role="search">
                                    <div class="input-group">
                                     <input type="text" class="form-control Search_Term" id='Search_Term_Mobile' placeholder="Search for Graduate Jobs" name="srch-term">
                                        <div class="input-group-btn">
