		...
		<?php while ( bp_thread_messages() ) : bp_thread_the_message(); ?>
			...
			<div class="message-box <?php bp_the_thread_message_alt_class(); ?>">
				...
				<div class="message-metadata">
					...
					<?php endif; ?>
						<small><span class="activity"><?php bp_the_thread_message_time_since(); ?></span></small>
					</div>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form">
			...
			<div class="message-box row">
				...
				<div class="message-content">
					...
					<textarea class="full" name="content" id="message_content" rows="5" cols="40"></textarea>
