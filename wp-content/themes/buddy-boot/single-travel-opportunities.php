...
<div class="row">
  <?php                
        $content='[ajaxy-live-search post_types="travel" label="Search for Travel" width="500" delay="300" width="500" url="http://localhost/LGWP/?s=%s" border="1px solid #eee"]';
...
<div class="row custom-tax-single">
	...
	<?php 
         ...
         $post_id= get_the_ID();
         $popup= new Popup_Filter($post_id, 'travel-opportunities', 'destination', 'destination');
