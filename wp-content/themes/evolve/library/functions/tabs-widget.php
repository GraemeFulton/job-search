    ...
    class evolve_Tabs_Widget extends WP_Widget {
        ...
        function __construct() {
            $widget_ops = array(
                ...
                'description' => __( 'Popular posts, recent post and comments.', 'evolve' )
            );

            $control_ops = array( 'id_base' => 'evolve_tabs-widget' );

            parent::__construct( 'evolve_tabs-widget', 'evolve: Tabs', $widget_ops, $control_ops );
        }
