	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p id="avatar-upload" class="break-row-top">
				...
				<input class="break-row-bottom" type="submit" name="upload" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" />
				<input class="break-row-bottom" type="hidden" name="action" id="action" value="bp_avatar_upload" />
			</p>
