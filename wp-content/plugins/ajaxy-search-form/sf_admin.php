...
<div class="wrap">
	...
	<input class="button-primary" onclick="return confirm('Are you sure you want to reset all your settings?');" name="sf_rsubmit" type="submit" value="Reset Setting to defaults" />
	<br class="clear"/>
	<br class="clear"/>
</div>