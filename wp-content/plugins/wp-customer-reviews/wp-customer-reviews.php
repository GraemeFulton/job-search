...
class WPCustomerReviews {
   ...
   if ( is_user_logged_in() ) 
   {
            ...
            $fields .= '<input class="text-input" type="hidden" id="' . $rand_prefixes[0] . '-fname" name="' . $rand_prefixes[0] . '-fname" value="' . $current_user->user_login  . '" />';
            }
            ...
            $fields .= '<input class="text-input" type="hidden" id="' . $rand_prefixes[1] . '-femail" name="' . $rand_prefixes[1] . '-femail" value="' . $current_user->user_email . '" />';
            }
