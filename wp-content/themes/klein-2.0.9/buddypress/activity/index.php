...
<div id="buddypress">
	...
	<div class="klein-activity-row break-row-bottom">
	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			<li class="feed">
				<a href="<?php bp_sitewide_activity_feed_link(); ?>" title="<?php _e( 'RSS Feed', 'buddypress' ); ?>">
				<i class="icon-rss"></i> <?php _e( 'RSS', 'buddypress' ); ?></a></li>

			<?php do_action( 'bp_activity_syndication_options' ); ?>

			<li id="activity-filter-select" class="last">
				<label class="pull-left" for="activity-filter-by"><?php _e( 'Show:', 'buddypress' ); ?></label>
				<select class="pull-left" id="activity-filter-by">
